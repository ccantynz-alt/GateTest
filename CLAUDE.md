...
- **Precision is measured on sixteen third-party repositories, covering all eight advertised languages** (`reliability-corpus/real-world.json`: express 0, flask 2, fastify 5, got 15, hono 33, zod 10, django 64, rails 46, spring-petclinic 9, gin 2, axum 6, laravel 4, CleanArchitecture 13, ktor 7, vapor 1; NodeGoat floor 40, measured 58 — the one that left was `docs:readme-usage`, now a warning). The last five were first-contact 28 / 28 / 39 / 21 / 6 — every drop was a scanner defect, not a suppression. CI job "real repos must not be blocked"; rendered at `/precision` from `website/app/data/precision.json`, regenerated nightly.
