...
| --- | --- | --- |
| 1 — Iterative fix loop | 2026-04-26 | 5/6 sub-tasks shipped (1.1 ✓, 1.2a ✓, 1.2b ✓ scaffold, 1.3 ✓, 1.4 ✓; 1.5 open). 1.2b + before/after-scan section in 1.4 both activate in production once scan-page wires `originalFileContents`+`originalFindings` into `/api/scan/fix`. |
