...
_Generated 2026-08-03T06:24:09.867Z_

Inputs: 109 session-fix(es), 0 fix-attempt(s), 0 MCP event(s).

## Recommendations

- **investigate-module** — `ci`: 11 session-fixes recorded — high-touch module, candidate for refactor or rule split
