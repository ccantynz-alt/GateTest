...
_Generated 2026-09-06T07:41:58.738Z_

Inputs: 136 session-fix(es), 0 fix-attempt(s), 0 MCP event(s).

## Recommendations

- **investigate-module** — `recall`: 12 session-fixes recorded — high-touch module, candidate for refactor or rule split
- **investigate-module** — `precision`: 12 session-fixes recorded — high-touch module, candidate for refactor or rule split
- **investigate-module** — `security`: 5 session-fixes recorded — high-touch module, candidate for refactor or rule split
