...
export const COUNTRIES: Country[] = [
  {
    ...
    whyGateTestFits:
      "US dev shops live inside four overlapping regimes — HIPAA for health, CCPA for consumer data, SOX for finance, PCI-DSS for cards. GateTest's 121 modules catch the technical findings each auditor looks for, in one scan, before code ships.",
  ...
  },
  {
    ...
    whyGateTestFits:
      "UK GDPR and the NCSC's Cyber Essentials scheme set a high bar for software shipped to UK customers. GateTest's 121 modules surface the technical findings the ICO and Cyber Essentials assessors care about — secret hygiene, dependency safety, error swallowing, PII in logs.",
  ...
  },
  {
    ...
    whyGateTestFits:
      "GDPR is the floor. NIS2 widened the scope to thousands more 'essential' and 'important' entities in 2024. DORA hit financial entities in January 2025. GateTest's 121 modules cover the technical-control evidence each one asks for, without forcing a tool sprawl.",
  ...
  },
  {
    ...
    whyGateTestFits:
      "The Privacy Act 1988 (as amended) and the ACSC Essential Eight together set the technical bar for Australian software. GateTest's 121 modules cover the secret-hygiene, dependency-safety, logging-discipline and configuration-hardening findings the OAIC and ACSC assessors look for.",
  ...
  },
  {
    ...
    whyGateTestFits:
      "The PDPA and the IM8 Instruction Manual together govern what Singapore software must do at the technical layer. GateTest's 121 modules catch the secret-hygiene, configuration-hardening, and dependency-safety findings the PDPC and IM8 assessors look for in one scan.",
  ...
  },
  {
    ...
    whyGateTestFits:
      "PIPEDA is the federal floor; Bill C-26 (the Critical Cyber Systems Protection Act) is layering critical-infrastructure obligations on top. GateTest's 121 modules cover the technical-control findings the OPC and CSE assessors look for under both regimes.",
    topThreeModules: ["secrets", "logPii", "dependencies"],
    complianceBullets: [
      {
