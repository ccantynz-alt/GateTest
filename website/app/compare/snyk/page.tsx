...
export const metadata: Metadata = {
  ...
  description:
    "Snyk ships separate Open Source, Code, Container, and IaC products. GateTest unifies those plus quality, performance, accessibility, and AI safety into a single config and a single bill — 120 modules, per-scan pricing.",
  keywords: [
    "Snyk alternative",
    "Snyk vs GateTest",
...
const faqItems = [
  ...
  },
  {
    ...
    a: "Snyk charges per developer seat per month — pricing scales with headcount and enterprise contracts can reach thousands monthly. GateTest charges per scan: $99 for all 120 modules. No seat licensing, no annual contracts, no per-developer billing. A 100-person team pays the same per scan as a solo developer.",
  },
  {
      ...
      <main className="px-6 py-16 max-w-5xl mx-auto">
        ...
        <section className="mb-16">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {[
              ...
              {
                title: "One bill, 120 modules",
                body: "Snyk's seat-based pricing means security costs scale with team size. GateTest is $99 for all 120 modules per scan. Run it daily on a 100-person team or run it once before a major release — the price is the same.",
              },
            ].map((card) => (
              <div
                key={card.title}
        ...
        <section className="rounded-2xl border border-teal-500/20 p-10 text-center" style={{ background: "rgba(20,184,166,0.05)" }}>
          ...
          <p className="text-white/60 mb-8 max-w-xl mx-auto">
            Get 120 modules — dependencies, code, containers, IaC, AI safety, accessibility, performance,
