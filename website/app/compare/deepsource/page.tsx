...
export const metadata: Metadata = {
  ...
  description:
    "DeepSource finds issues. GateTest finds AND fixes them. 67 modules, pay-on-completion pricing, no per-seat licensing, AI-powered auto-fix PRs created in seconds.",
  keywords: [
  ...
  openGraph: {
    title: "GateTest vs DeepSource — AI-Native Code Quality in 2026",
    description:
      "DeepSource finds issues. GateTest finds AND fixes them. 67 modules, pay-on-completion pricing, no per-seat licensing, AI-powered auto-fix PRs.",
...
const faqItems = [
  ...
  },
  {
    ...
    a: "GateTest quick scans (4 modules) complete in under 15 seconds. Full 67-module scans complete in under 60 seconds. DeepSource runs asynchronously in the background and varies widely by repo size. GateTest gives you synchronous results within the CI timeout window — no waiting for background workers.",
  },
  {
...
const comparisonRows = [
  ...
  { feature: "67 modules in one gate", gatetest: true, competitor: false },
];
      ...
      <main className="px-6 py-16 max-w-5xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <p className="text-lg text-white/60 max-w-2xl leading-relaxed">
            ...
            67 modules, generative AI code review using Claude, auto-fix PRs that write real code,
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {[
              ...
              },
              {
                ...
                body: "DeepSource charges a monthly subscription per seat. A 10-person team might run 5 scans a month or 500 — the bill is the same. GateTest charges per result: $99 for all 67 modules per scan. Scan before releases, scan after major features, scan daily — you control the spend.",
              },
              {
        ...
        <section className="rounded-2xl border border-teal-500/20 p-10 text-center" style={{ background: "rgba(20,184,166,0.05)" }}>
          ...
          <p className="text-white/60 mb-8 max-w-xl mx-auto">
            67 modules, AI-powered review, auto-fix PRs — all in one scan. Pay only when results are delivered.
          </p>
          <Link
            href="/"
