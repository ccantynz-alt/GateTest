...
export const metadata: Metadata = {
  ...
  description:
    "DeepSource finds issues. GateTest finds AND fixes them. 91 modules, pay-on-completion pricing, no per-seat licensing, AI-powered auto-fix PRs created in seconds.",
  keywords: [
  ...
  openGraph: {
    title: "GateTest vs DeepSource — AI-Native Code Quality in 2026",
    description:
      "DeepSource finds issues. GateTest finds AND fixes them. 91 modules, pay-on-completion pricing, no per-seat licensing, AI-powered auto-fix PRs.",
...
const comparisonRows = [
  ...
  { feature: "91 modules in one gate", gatetest: true, competitor: false },
];
      ...
      <main className="px-6 py-16 max-w-5xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <p className="text-lg text-white/60 max-w-2xl leading-relaxed">
            ...
            91 modules, generative AI code review using Claude, auto-fix PRs that write real code,
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {[
              ...
              },
              {
                ...
                body: "DeepSource charges a monthly subscription per seat. A 10-person team might run 5 scans a month or 500 — the bill is the same. GateTest charges per result: $99 for all 91 modules per scan. Scan before releases, scan after major features, scan daily — you control the spend.",
              },
              {
        ...
        <section className="rounded-2xl border border-teal-500/20 p-10 text-center" style={{ background: "rgba(20,184,166,0.05)" }}>
          ...
          <p className="text-white/60 mb-8 max-w-xl mx-auto">
            91 modules, AI-powered review, auto-fix PRs — all in one scan. Pay only when results are delivered.
          </p>
          <Link
            href="/"
