...
export const metadata: Metadata = {
  ...
  description:
    "DeepSource finds issues. GateTest finds them and — at the Scan + Fix tier ($199) and above — fixes them. 120 modules, per-scan pricing, no per-seat licensing, AI auto-fix PRs created in seconds.",
  keywords: [
...
const comparisonRows = [
  ...
  { feature: "120 modules in one gate", gatetest: true, competitor: false },
];
      ...
      <main className="px-6 py-16 max-w-5xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <p className="text-lg text-white/60 max-w-2xl leading-relaxed">
            ...
            120 modules, generative AI code review using Claude, AI auto-fix PRs that write real code at the Scan + Fix tier ($199) and Forensic Scan ($399),
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {[
              ...
              },
              {
                ...
                body: "DeepSource charges a monthly subscription per seat. A 10-person team might run 5 scans a month or 500 — the bill is the same. GateTest charges per result: $99 for all 120 modules per scan. Scan before releases, scan after major features, scan daily — you control the spend.",
              },
              {
        ...
        <section className="rounded-2xl border border-teal-500/20 p-10 text-center" style={{ background: "rgba(20,184,166,0.05)" }}>
          ...
          <p className="text-white/60 mb-8 max-w-xl mx-auto">
            120 modules and AI-powered review on every paid tier. AI auto-fix PRs at Scan + Fix ($199) and Forensic Scan ($399). One-time payment per scan.
          </p>
          <Link
            href="/"
