...
const faqItems = [
  ...
  },
  {
    ...
    a: "SonarQube Cloud charges per active user per month. SonarQube Community Edition requires you to run your own server. GateTest charges per scan — $29 for a quick scan, $99 for all 67 modules. You pay only when the scan completes and delivers results. No server to maintain, no per-seat licensing, no annual contracts.",
  },
  {
  ...
  },
  {
    ...
    a: "GateTest goes further than suggestions. The AI-powered auto-fix mode (Scan + Fix, $199) creates an actual pull request with working code changes. SonarQube shows you the issue; GateTest writes the fix.",
  },
];
      ...
      <main className="px-6 py-16 max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {[
              ...
              },
              {
                ...
                body: "SonarQube Cloud pricing scales with developer headcount — the more your team grows, the higher your bill. GateTest charges per result: $29 quick scan, $99 full 67-module scan. A 50-person team pays the same as a solo founder for the same scan.",
              },
              {
        ...
        <section className="rounded-2xl border border-teal-500/20 p-10 text-center" style={{ background: "rgba(20,184,166,0.05)" }}>
          ...
          <p className="text-white/60 mb-8 max-w-xl mx-auto">
            Paste your repo URL and get a full 67-module scan in under 60 seconds. No server setup,
