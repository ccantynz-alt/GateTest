...
const PRODUCTS = [
  {
    ...
    body:
      "QA + security audit for your codebase OR your live website. 121 modules covering security, performance, accessibility, SEO, supply chain, AI safety. Pay per scan, not per seat.",
    bullets: [
