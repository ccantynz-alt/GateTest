...
const TIER_DESCRIPTIONS = {
  ...
  full:     { label: 'Full',      priceUsd: 99,  description: 'All 121 modules + AI code review + every clustered issue + health score (scan-only, no auto-fix)' },
  scan_fix: { label: 'Scan + Fix', priceUsd: 199, description: 'All 121 modules + AI auto-fix PR + regression tests + pair-review' },
