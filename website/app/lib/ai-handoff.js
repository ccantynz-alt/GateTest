...
function formatForClaudeCode(findings, opts = {}) {
  ...
  return [
    ...
    '',
    '---',
    '_Generated by GateTest — gatetest.io_',
  ].join('\n');
}
...
function formatForGitHubIssue(findings, opts = {}) {
  ...
  return [
    ...
    meta,
    '',
    '> Filed automatically from a [GateTest](https://gatetest.io) scan. GateTest runs 120 modules covering security, supply-chain, accessibility, infra hygiene, AI-app safety, and more.',
    '',
