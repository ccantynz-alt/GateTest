...
function renderReport({ hostName, scanDate, tier, narrative, findings, chains, complianceGaps, roadmap }) {
  ...
  lines.push(
    ...
    `---`,
    ``,
    `*Report generated by GateTest Forensic — [gatetest.io](https://gatetest.io)*`,
 ...
 */
async function generateCisoReport({ findings = [], chains = [], hostName = 'Unknown', scanDate, tier = 'Forensic', askClaude }) {
