export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center hero-bg overflow-hidden pt-20">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1200px] h-[600px] bg-gradient-to-b from-indigo-50/80 to-transparent rounded-full blur-[80px] pointer-events-none" />

      <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
        {/* Badge */}
        <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-indigo-50 border border-indigo-100 text-sm text-indigo-600 font-medium mb-10 fade-up">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20 fade-up">
          <a href="#pricing" className="btn-primary px-8 py-4 text-base pulse-glow">
        ...
        {/* Terminal demo — dark terminal on light page creates contrast */}
        <div className="max-w-3xl mx-auto terminal fade-up">
          ...
          <div className="p-6 font-[var(--font-mono)] text-sm text-left space-y-1.5 leading-relaxed text-gray-300">
            ...
            <p>{"  "}<span className="text-green-400">&#10003;</span> security <span className="text-gray-500">— 0 vulns, OWASP clean</span></p>
            <p>{"  "}<span className="text-green-400">&#10003;</span> accessibility <span className="text-gray-500">— WCAG 2.2 AAA</span></p>
            <p>{"  "}<span className="text-green-400">&#10003;</span> performance <span className="text-gray-500">— 98/100, LCP 1.1s</span></p>
