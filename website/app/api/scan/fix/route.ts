...
Every fix in this PR was generated by Claude AI and verified against GateTest's 84-module scanner before being committed. Fixes that introduced new issues were automatically rejected and retried.
...
<sub>Scanned and fixed by <a href="https://gatetest.ai">GateTest</a> — 84 modules, AI-powered, verify-before-commit</sub>`;
