...
/**
 * Anthropic endpoint + API-version configuration — engine-side twin of
 * website/app/lib/anthropic-config.js. Kept as a separate file because src/
 * is CommonJS and cannot import from website/ (same constraint as
